...
public class RotateLoadingView extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            ...
            color = typedArray.getColor(R.styleable.RotateLoadingView_loading_color, Color.WHITE);
            width = typedArray.getDimensionPixelSize(R.styleable.RotateLoadingView_loading_width, dpToPx(context, DEFAULT_WIDTH));
            shadowPosition = typedArray.getInt(R.styleable.RotateLoadingView_shadow_position, DEFAULT_SHADOW_POSITION);
            speedOfDegree = typedArray.getInt(R.styleable.RotateLoadingView_loading_speed, DEFAULT_SPEED_OF_DEGREE);
            typedArray.recycle();
        }
