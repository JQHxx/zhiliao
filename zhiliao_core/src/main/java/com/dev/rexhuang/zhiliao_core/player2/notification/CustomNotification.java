package com.dev.rexhuang.zhiliao_core.player2.notification;
...
import com.dev.rexhuang.zhiliao_core.player2.notification.utils.NotificationColorUtils;
...
public class CustomNotification extends BroadcastReceiver implements INotification {
    ...
    private Notification createNotification() {
        ...
        for (MusicEntity info : musicEntities) {
            if (info.getId().equals(songId)) {
                musicEntity = info;
                break;
            }
        }
        updateRemoteViewUI(mNotification, musicEntity, smallIcon);
     ...
     * 更新RemoteViews
     */
    private void updateRemoteViewUI(Notification notification, MusicEntity musicEntity, int smallIcon) {
        ...
        String artistName = musicEntity != null ? musicEntity.getSingers().get(0).getName() : "";
        String songName = musicEntity != null ? musicEntity.getName() : "";
        //设置文字内容
