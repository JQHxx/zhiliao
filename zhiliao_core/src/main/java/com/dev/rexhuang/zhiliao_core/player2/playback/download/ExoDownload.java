...
public class ExoDownload {
    ...
    public static ExoDownload getInstance() {
        return ExoDownloadHolder.INSTANCE;
    }

    private static class ExoDownloadHolder {
        private static final ExoDownload INSTANCE = new ExoDownload();
    }
    ...
    public DataSource.Factory buildDataSourceFactory(Context context) {
        DefaultDataSourceFactory upstreamFactory =
                new DefaultDataSourceFactory(context, builHttpDataSourceFactory());
        return buildReadOnlyCacheDataSource(upstreamFactory, getDownloadCache());
    }

    public HttpDataSource.Factory builHttpDataSourceFactory() {
