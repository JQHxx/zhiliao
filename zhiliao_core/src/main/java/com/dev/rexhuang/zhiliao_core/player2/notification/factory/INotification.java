...
public interface INotification {
    ...
    //action
    String ACTION_PLAY_OR_PAUSE = "com.dev.rexhuang.zhiliao_core.play_or_pause";
    String ACTION_PAUSE = "com.dev.rexhuang.zhiliao_core.pause";
    String ACTION_PLAY = "com.dev.rexhuang.zhiliao_core.play";
    String ACTION_PREV = "com.dev.rexhuang.zhiliao_core.prev";
    String ACTION_NEXT = "com.dev.rexhuang.zhiliao_core.next";
    String ACTION_STOP = "com.dev.rexhuang.zhiliao_core.stop";
    String ACTION_CLOSE = "com.dev.rexhuang.zhiliao_core.close";
    String ACTION_FAVORITE = "com.dev.rexhuang.zhiliao_core.favorite";
    String ACTION_LYRICS = "com.dev.rexhuang.zhiliao_core.lyrics";
    String ACTION_DOWNLOAD = "com.dev.rexhuang.zhiliao_core.download";
    String ACTION_INTENT_CLICK = "com.dev.rexhuang.zhiliao_core.EXTRY_NOTIFICATION_TO_MAINACTIVITY";

    String ACTION_UPDATE_FAVORITE_UI = "com.dev.rexhuang.zhiliao_core.update_favorite_ui";
    String ACTION_UPDATE_LYRICS_UI = "com.dev.rexhuang.zhiliao_core.update_lyrics_ui";

    String CHANNEL_ID = "com.dev.rexhuang.zhiliao_core.MUSIC_CHANNEL_ID";
